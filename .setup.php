...
\033[01;31m      _\033[01;33m ____    _
 ...
 }\033[01;31m------------- \033[01;32m Installing IP-Tracer Plus \033[01;31m -------------\033[01;37m{
...
EOL;
    ...
    if (file_exists("/usr/bin/ip-tracer") || file_exists("/data/data/com.termux/files/usr/bin/ip-tracer")) {
      echo "\033[01;32m      IP-Tracer installed Successfully ( Dont Use illgle Activities ) !!!\033[00m\n";
      echo <<<EOL
...
EOL;
      ...
      echo "\n\n\033[01;31m  Sorry IP-Tracer is not installed Try Again Use Commands Correctly !!!\033[00m";
    }
  }
}
$a=new set;
